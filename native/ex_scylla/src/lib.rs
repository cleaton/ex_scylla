...
rustler::init!(
    ...
    [
        ...
        */
        ...
        prepared_statement::ps_get_use_cached_result_metadata,
        prepared_statement::ps_set_use_cached_result_metadata,
