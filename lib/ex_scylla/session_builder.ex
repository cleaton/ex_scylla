defmodule ExScylla.SessionBuilder do
  ...
  native_f(
    func: :refresh_metadata_on_auto_schema_agreement,
  ...
  native_f(
    func: :tracing_info_fetch_attempts,
    args: [sb, attempts],
  ...
  native_f(
    func: :tracing_info_fetch_consistency,
    args: [sb, consistency],
  ...
  native_f(
    func: :tracing_info_fetch_interval,
    args: [sb, interval_ms],
    args_spec: [T.session_builder(), non_neg_integer()],
    return_spec: T.session_builder(),
    doc_example: """
