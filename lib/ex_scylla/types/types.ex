defmodule ExScylla.Types do
  ...
  @type speculative_execution_policy :: SimpleSpeculativeExecutionPolicy.t() | PercentileSpeculativeExecutionPolicy.t()
  ...
  @type column_type :: {:custom, String.t()}
                     | :ascii
                     | :boolean
                     | :blob
                     | :counter
