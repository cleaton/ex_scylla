defmodule ExScylla.Native do
  use Rustler,
      ...
      #def sb_tracing_info_fetch_attemts(), do: e()
      #def sb_tracing_info_fetch_consistency, do: e()
      #def sb_tracing_info_fetch_interval(), do: e()
      ...
      def epb_load_balancing_policy(_epb, _lb_policy), do: e()
      ...
      def dpb_latency_awareness, do: e()
      def dpb_new, do: e()
      def dpb_permit_dc_failover, do: e()
      def dpb_prefer_datacenter, do: e()
      def dpb_prefer_rack, do: e()
      def dpb_token_aware, do: e()
      # LatencyAwarenessBuilder
      def lab_exclusion_threshold, do: e()
      def lab_minimum_measurements, do: e()
      def lab_new, do: e()
      def lab_retry_period, do: e()
      def lab_scale, do: e()
      def lab_update_rate, do: e()
