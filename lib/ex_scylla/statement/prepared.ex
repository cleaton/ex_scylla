defmodule ExScylla.Statement.Prepared do
  ...
  native_f(
    func: :compute_partition_key,
    args: [ps, bound_values],
    args_spec: [T.prepared_statement(), T.values()],
    return_spec:
      {:ok, binary()} | T.parse_error() | SerializeValuesError.t() | PartitionKeyError.t(),
  ...
  native_f(
    func: :get_execution_profile_handle,
    args: [ps],
  ...
  native_f(
    func: :set_execution_profile_handle,
  ...
  native_f(
    func: :get_use_cached_result_metadata,
    args: [ps],
    args_spec: [T.prepared_statement()],
    return_spec: boolean(),
    example_setup: :ps_setup,
  ...
  native_f(
    func: :set_use_cached_result_metadata,
